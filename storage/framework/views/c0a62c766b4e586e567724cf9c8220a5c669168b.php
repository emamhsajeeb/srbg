                                        ...
                                        <div class="" id="Basic" role="">
                                            ...
                                            <form method="post" id="basic_sample_form" class="form-horizontal"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4 form-group">
                                                        <label><?php echo e(trans('Office Shift')); ?> <span class="text-danger">*</span></label>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/srbgcomb/public_html/resources/views/employee/dashboard.blade.php ENDPATH**/ ?>